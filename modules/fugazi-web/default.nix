...
let
  ...
  src = builtins.fetchTarball {
    url = "https://github.com/acpuchades/fugazi-web/archive/d810646b5eddff9a887b37e2eaeb8a392569c520.tar.gz";
    sha256 = "sha256-TmqSlU9A839V3lKX1x4WN4pXqv4IMX7gQmwTIy7gMzw=";
  };
